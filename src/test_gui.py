...
def run_text_command(event=None):
    ...
    results, raw_output = handle_user_input(user_input, robot_state)
...
def show_state():
    state_text.insert(tk.END, robot_state.get_status() + "\n\n")
...
title_label = tk.Label(root, text="Robot AI Agent Test GUI", font=("Arial", 16))
